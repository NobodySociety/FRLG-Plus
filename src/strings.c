...
const u8 gUnknown_8417920[] = _("Toxi");
...
const u8 gText_FreshWater[] = _("Freh Water");
...
const u8 gPCText_Machine[] = _("Titles");
...
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("Pokémon Skill");
